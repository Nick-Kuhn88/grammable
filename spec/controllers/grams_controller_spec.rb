...
RSpec.describe GramsController, type: :controller do
  ...
  describe "grams#destroy action" do
    ...
    it "should return a 404 messagie if we cannot find a gram with the id thtis is specified" do
      user = FactoryBot.create(:user)
      sign_in user
  ...
  describe "grams#update action" do
    ...
    it "souldn't let users who didn't create the gram to update it" do
      gram = FactoryBot.create(:gram)
      user = FactoryBot.create(:user)
      sign_in user
